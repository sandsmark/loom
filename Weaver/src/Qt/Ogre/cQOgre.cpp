...
/**********************************************************************/
{
	...
	Ogre::String vB = vPath + "config/Weaver.cfg";    
	Ogre::String vC = vPath + "../logs/Weaver.log";
...
/************************************************************************/
void Loom::Weaver::cQOgre::OnSetPosition( const Ogre::String &iName, const Ogre::Vector3 &iPosition )
/************************************************************************/
{
