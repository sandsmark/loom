...
class cAvatarResponderGetEffectorRotation : public IAvatarResponder<cAvatarResponderGetEffectorRotation>
{
public:
	class cParam
	{
...
public:
	cAvatarResponderGetEffectorRotation() : IAvatarResponder( _T("Avatar::cAvatarResponderSetRotation") ) {}
