...
/************************************************************************/
cControllerTest2::cControllerTest2()
...
/************************************************************************/
void cControllerTest2::Init( cOgreAvatar *iAvatar )
/************************************************************************/
{
...
//	mLeftHand = mAvatar->GetNode()->_getFullTransform() * mAvatar->GetEffectorPosition( EFFECTOR_RIGHT_HAND );
	...
	mRightHand = mAvatar->GetNode()->_getFullTransform().inverse() * Ogre::Vector3(  14, -1, -100 ) * 2; 
	mLeftHand = mAvatar->GetNode()->_getFullTransform().inverse() * Ogre::Vector3( -14, -1, -50 ) * 2; 
...
/************************************************************************/
void Loom::Avatar::cControllerTest2::UpdateStageOne( void )
/************************************************************************/
{
	DWORD vTime = GetTickCount();
	float vEllapsed = ( vTime - mLastUpdate ) * 0.001f;
...
//	mRightHand = mAvatar->GetNode()->_getFullTransform().inverse() * vPos; 
	mRightHand = mAvatar->GetNode()->_getFullTransform().inverse() * Ogre::Vector3( 8, -0.5f, -95 ) * 2;
...
/************************************************************************/
void Loom::Avatar::cControllerTest2::UpdateStageTwo( void )
/************************************************************************/
{
	DWORD vTime = GetTickCount();
	float vEllapsed = ( vTime - mLastUpdate ) * 0.001f;
...
/************************************************************************/
void Loom::Avatar::cControllerTest2::UpdateStageThree( void )
/************************************************************************/
{
	DWORD vTime = GetTickCount();
	float vEllapsed = ( vTime - mLastUpdate ) * 0.001f;
...
/************************************************************************/
void Loom::Avatar::cControllerTest2::UpdateStageFour( void )
/************************************************************************/
{
	DWORD vTime = GetTickCount();
	float vEllapsed = ( vTime - mLastUpdate ) * 0.001f;
...
/************************************************************************/
void Loom::Avatar::cControllerTest2::UpdateStageFive( void )
/************************************************************************/
{
	DWORD vTime = GetTickCount();
	float vEllapsed = ( vTime - mLastUpdate ) * 0.001f;
...
/************************************************************************/
void Loom::Avatar::cControllerTest2::UpdateStageSix( void )
/************************************************************************/
{
	DWORD vTime = GetTickCount();
	float vEllapsed = ( vTime - mLastUpdate ) * 0.001f;
	...
	mRightHand = mAvatar->GetNode()->_getFullTransform().inverse() * Ogre::Vector3( -14, -0.5f, -110 ) * 2.0f;
	mAvatar->SetEffectorPosition( EFFECTOR_RIGHT_HAND, mPrevPos + ( mRightHand - mPrevPos ) * vAlpha );
}

/************************************************************************/
void Loom::Avatar::cControllerTest2::UpdateStageSeven( void )
/************************************************************************/
{
	DWORD vTime = GetTickCount();
	float vEllapsed = ( vTime - mLastUpdate ) * 0.001f;
...
//	vPos.y += 10.0f;
//	mRightHand = mAvatar->GetNode()->_getFullTransform().inverse() * vPos; 
	mRightHand = mAvatar->GetNode()->_getFullTransform().inverse() * Ogre::Vector3( -18, -0.5f, -95 ) * 2;
	mAvatar->SetEffectorPosition( EFFECTOR_RIGHT_HAND, mPrevPos + ( mRightHand - mPrevPos ) * vAlpha );
...
/************************************************************************/
void Loom::Avatar::cControllerTest2::UpdateStageEight( void )
/************************************************************************/
{
	DWORD vTime = GetTickCount();
	float vEllapsed = ( vTime - mLastUpdate ) * 0.001f;
...
/************************************************************************/
void Loom::Avatar::cControllerTest2::UpdateStageNine( void )
/************************************************************************/
{
	DWORD vTime = GetTickCount();
	float vEllapsed = ( vTime - mLastUpdate ) * 0.001f;
...
/************************************************************************/
void Loom::Avatar::cControllerTest2::UpdateStageTen( void )
/************************************************************************/
{
	DWORD vTime = GetTickCount();
	float vEllapsed = ( vTime - mLastUpdate ) * 0.001f;
...
/************************************************************************/
void Loom::Avatar::cControllerTest2::UpdateStageEleven( void )
/************************************************************************/
{
	DWORD vTime = GetTickCount();
	float vEllapsed = ( vTime - mLastUpdate ) * 0.001f;
...
/************************************************************************/
void Loom::Avatar::cControllerTest2::UpdateStageTwelve( void )
/************************************************************************/
{
	DWORD vTime = GetTickCount();
	float vEllapsed = ( vTime - mLastUpdate ) * 0.001f;
